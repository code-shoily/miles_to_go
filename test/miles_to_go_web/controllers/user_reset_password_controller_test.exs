defmodule MilesToGoWeb.UserResetPasswordControllerTest do
  ...
  describe "GET /users/reset_password" do
    test "renders the reset password page", %{conn: conn} do
      ...
      assert response =~
               ~s{<div class="title is-3 has-text-primary has-text-centered">Forgot your password?</div>}
    end
  end
  ...
  describe "GET /users/reset_password/:token" do
    ...
    test "renders reset password", %{conn: conn, token: token} do
      ...
      assert html_response(conn, 200) =~
               ~s{<div class="title is-3 has-text-primary has-text-centered">Reset Password</div>}
    end
