defmodule MilesToGo.AccountsTest do
  use MilesToGo.DataCase

  alias MilesToGo.Accounts
  import MilesToGo.AccountsFixtures
  alias MilesToGo.Accounts.{User, UserToken}
  ...
  describe "change_user_registration/2" do
    test "returns a changeset" do
      ...
      assert Enum.sort(changeset.required) ==
               Enum.sort([:name, :password, :email, :date_of_birth])
    end
    ...
    test "passwords must match confirmation" do
      email = unique_user_email()
      password = valid_user_password()
